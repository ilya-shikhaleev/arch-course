...
helm.sh/chart: {{ include "payment-chart.chart" . }}
{{ include "payment-chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "payment-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "payment-chart.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
